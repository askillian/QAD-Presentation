...
Optional: Visualize this by plotting the pseudo observations of your generated sample into the mass-plot (Compare: slide 12,13).
...
coef(mod, select = c("q(x1,x2)","q(x1,x2)","mean.dependence",
                     "asymmetry"))
```
...
## Exercise 2
  ...
  * This does not makes sense for all columns. (why?)
