...
There are plenty of real examples as well:

```{r, message = FALSE, fig.height=3.5}
# I simply cannot find good ones!
```
...
```{r}
if(coef(mod, select = 'q(x2,x1)') > c){
 print(paste('q(x2,x1)','>',c,sep=' '))
 print('Reject H0')
}else{
 print(paste('q(x2,x1)','<=',c,sep=' '))
 print('Accept H0')
